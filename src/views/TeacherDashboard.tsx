    ...
    >
      {activeTab === "dashboard" && !selectedStudent && (
        <div className="space-y-6 animate-fade-in">
          <h2 className="font-heading font-extrabold text-3xl text-[#0b192c]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-white p-6 rounded-2xl border border-[#dce9f8] shadow-sm">
              ...
              <div className="text-3xl font-extrabold text-[#0284c7] mt-1">
                {loadingStats ? "..." : stats.totalEvaluations}
              </div>
            </div>

            <div
              className="bg-white p-6 rounded-2xl border border-[#dce9f8] shadow-sm cursor-pointer hover:border-[#0284c7] transition-colors"
            ...
            >
              ...
              <div className="text-3xl font-extrabold text-[#0b192c] mt-1">
                42
              </div>
            </div>
      ...
      {activeTab === "create" && (
        <CreateEvaluationView teacherId={userId} />
      )}
        ...
        <div className="space-y-6 animate-fade-in pb-10">
          <div>
            ...
            <p className="text-slate-500 font-medium mt-1">
              Deep dive into student performance and AI evaluation metrics.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-[#f0f9ff] to-[#e0f2fe] border border-[#bae6fd] p-5 rounded-2xl flex items-start gap-4">
            ...
            <div>
              <h4 className="font-bold text-[#0369a1] mb-1">
                AI Actionable Insights
              </h4>

              <p className="text-sm text-[#075985] leading-relaxed mb-3 font-medium">
                The majority of your class is struggling with{" "}
                <strong className="font-bold">Wave Mechanics</strong>{" "}
                (54% mastery). Consider scheduling a revision session on this
                topic. Conversely,{" "}
                <strong className="font-bold">Newton's Laws</strong> show
                excellent retention (85% mastery).
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Trend Chart */}
            <div className="bg-white p-6 rounded-2xl border border-[#dce9f8] shadow-sm">
              <h3 className="font-bold text-lg text-[#0b192c] mb-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-[#dce9f8] shadow-sm flex flex-col">
              <h3 className="font-bold text-lg text-[#0b192c] mb-4">
      ...
      {activeTab === "students" && selectedStudent && (
        <div className="space-y-6 animate-fade-in">
          ...
          <h2 className="font-heading font-extrabold text-2xl text-[#0b192c]">
            {selectedStudent} — Learning Profile
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-[#dce9f8] shadow-sm">
              <h3 className="font-bold text-lg text-rose-800 mb-4">
                Weak Concepts
              </h3>
          ...
          <div className="bg-[#fff1f2] border border-[#fecdd3] p-6 rounded-2xl">
            ...
            <p className="text-sm text-rose-950 font-medium">
              Repeatedly missing units in final answers, and struggling with
              theoretical explanations vs pure numerical calculation.
            </p>
          </div>
        </div>
      )}
      ...
      {activeTab === "architecture" && (
        <div className="space-y-6 animate-fade-in">
          <h2 className="font-heading font-extrabold text-3xl text-[#0b192c]">
            How EduEval AI Works
          </h2>

          <p className="text-slate-600 font-medium mb-8">
            Our pipeline digitizes handwritten tests, extracts concepts via
            LLM, and maps them against your evaluation criteria.
          </p>

          <ArchitectureDiagram
            onOpenEvaluationStudio={() => setActiveTab("evaluations")}
          />
        </div>
      )}
